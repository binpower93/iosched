...
import uk.ac.ntu.n0377645.fyp.ui.widget.DrawShadowFrameLayout;
...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = Config.CONTENT_URI + ".STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = Config.CONTENT_URI + ".STATE_KEY_TOPIC";
