...
package uk.ac.ntu.n0377645.fyp.provider;

import uk.ac.ntu.n0377645.fyp.appwidget.ScheduleWidgetProvider;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Announcements;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.PeopleIveMet;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Blocks;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Experts;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Feedback;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.MapMarkers;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.MapTiles;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Rooms;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.SearchSuggest;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Sessions;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Speakers;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.Tags;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleDatabase.SessionsSearchColumns;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleDatabase.SessionsSpeakers;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleDatabase.Tables;
import uk.ac.ntu.n0377645.fyp.util.SelectionBuilder;
...
import uk.ac.ntu.n0377645.fyp.Config;
import uk.ac.ntu.n0377645.fyp.appwidget.ScheduleWidgetProvider;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract.*;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleDatabase.SessionsSearchColumns;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleDatabase.SessionsSpeakers;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleDatabase.Tables;
import uk.ac.ntu.n0377645.fyp.util.AccountUtils;
import uk.ac.ntu.n0377645.fyp.util.SelectionBuilder;
...
import static uk.ac.ntu.n0377645.fyp.util.LogUtils.LOGD;
import static uk.ac.ntu.n0377645.fyp.util.LogUtils.LOGV;
import static uk.ac.ntu.n0377645.fyp.util.LogUtils.makeLogTag;

/**
 * Provider that stores {@link ScheduleContract} data. Data is usually inserted
 * by {@link uk.ac.ntu.n0377645.fyp.sync.SyncHelper}, and queried by various
