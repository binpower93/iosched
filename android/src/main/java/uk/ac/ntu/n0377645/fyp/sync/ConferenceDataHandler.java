...
package uk.ac.ntu.n0377645.fyp.sync;
...
import uk.ac.ntu.n0377645.fyp.io.BlocksHandler;
import uk.ac.ntu.n0377645.fyp.io.ExpertsHandler;
import uk.ac.ntu.n0377645.fyp.io.HashtagsHandler;
import uk.ac.ntu.n0377645.fyp.io.JSONHandler;
import uk.ac.ntu.n0377645.fyp.io.MapPropertyHandler;
import uk.ac.ntu.n0377645.fyp.io.PartnersHandler;
import uk.ac.ntu.n0377645.fyp.io.RoomsHandler;
import uk.ac.ntu.n0377645.fyp.io.SearchSuggestHandler;
import uk.ac.ntu.n0377645.fyp.io.SessionsHandler;
import uk.ac.ntu.n0377645.fyp.io.SpeakersHandler;
import uk.ac.ntu.n0377645.fyp.io.TagsHandler;
import uk.ac.ntu.n0377645.fyp.io.VideosHandler;
import uk.ac.ntu.n0377645.fyp.io.map.model.Tile;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract;
import uk.ac.ntu.n0377645.fyp.util.FileUtils;
import uk.ac.ntu.n0377645.fyp.util.Lists;
import uk.ac.ntu.n0377645.fyp.util.MapUtils;

import static uk.ac.ntu.n0377645.fyp.util.LogUtils.LOGD;
import static uk.ac.ntu.n0377645.fyp.util.LogUtils.LOGE;
import static uk.ac.ntu.n0377645.fyp.util.LogUtils.LOGW;
...
public class ConferenceDataHandler {
    ...
    public void applyConferenceData(String[] dataBodies, String dataTimestamp,
        ...
        try {
            ...
            if (operations > 0 && operations < 1000) {
                mContext.getContentResolver().applyBatch(ScheduleContract.CONTENT_AUTHORITY, batch);
            } else if (operations > 1000) {
                List<ArrayList<ContentProviderOperation>> batches = new ArrayList<>();
                int i = operations / 1000;
                for(int n = 0; n < i; n++) {
                    ArrayList<ContentProviderOperation> smallBatch = new ArrayList<>();
                    for(int x  = 0; x < 1000; x++) {
                        try {
                            ContentProviderOperation contentProviderOperation = batch.get(n*x);
                            smallBatch.add(contentProviderOperation);

                        } catch (IndexOutOfBoundsException ex) {
                            break;
                        }
                    }
                    batches.add(smallBatch);
                }

                for(ArrayList<ContentProviderOperation> smallBatch : batches) {
                    mContext.getContentResolver().applyBatch(ScheduleContract.CONTENT_AUTHORITY, smallBatch);
                }
            }
