...
import uk.ac.ntu.n0377645.fyp.model.ScheduleHelper;
import uk.ac.ntu.n0377645.fyp.provider.ScheduleContract;
import uk.ac.ntu.n0377645.fyp.ui.widget.MyScheduleView;
import uk.ac.ntu.n0377645.fyp.ui.widget.SlidingTabLayout;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = Config.CONTENT_URI + ".ARG_CONFERENCE_DAY_INDEX";
    ...
    public static final String EXTRA_DIALOG_TITLE
            = Config.CONTENT_URI + ".EXTRA_DIALOG_TITLE";
    public static final String EXTRA_DIALOG_MESSAGE
            = Config.CONTENT_URI + ".EXTRA_DIALOG_MESSAGE";
    public static final String EXTRA_DIALOG_YES
            = Config.CONTENT_URI + ".EXTRA_DIALOG_YES";
    public static final String EXTRA_DIALOG_NO
            = Config.CONTENT_URI + ".EXTRA_DIALOG_NO";
    public static final String EXTRA_DIALOG_URL
            = Config.CONTENT_URI + ".EXTRA_DIALOG_URL";
