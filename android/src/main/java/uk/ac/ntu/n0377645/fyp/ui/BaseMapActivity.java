...
import uk.ac.ntu.n0377645.fyp.nearby.MetadataResolver;
import uk.ac.ntu.n0377645.fyp.nearby.NearbyDeviceManager;
import uk.ac.ntu.n0377645.fyp.ui.widget.ScrimInsetsFrameLayout;
...
public abstract class BaseMapActivity extends BaseActivity implements NearbyFragment.Callbacks, ScrimInsetsFrameLayout.OnInsetsCallback {
    ...
    public static final String EXTRA_DETACHED_MODE
            = Config.CONTENT_URI + ".EXTRA_DETACHED_MODE";
