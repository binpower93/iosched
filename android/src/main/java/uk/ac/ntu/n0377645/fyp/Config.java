...
package uk.ac.ntu.n0377645.fyp;
...
public class Config {
    ...
    // YouTube API config
    public static final String YOUTUBE_API_KEY = "AIzaSyCx8PylsURXRW_t0NR1B07g4Bx-co0_TbE";
    ...
    public static final String CONTENT_URI = "uk.ac.ntu.n0377645.fyp";
}
